...
public class SceneChangeEditor : Editor
{
    ...
    private static void TitleScene() => LoadScene("Assets/@Scenes/TitleScene.unity");

    [MenuItem("Tools/SceneChange/GameScene &2")]
    private static void GameScene() => LoadScene("Assets/@Scenes/GameScene.unity");

    [MenuItem("Tools/SceneChange/DevScene &`")]
    private static void DevScene() => LoadScene("Assets/@Scenes/DevScene.unity");
